function [ i ] = mi_lcn_rc_fh( pX, pY, pXY )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Description: calculate local mutual information normalized by -log2(p(x,y)) 
% between event x of variable X and event y of Variable Y.
%
% Usage: i = mi_lcn_rc_fh( pX, pY, pXY )
% Input:
...
pXY0 = bsxfun(@minus,pX,pXY);
ic = -bsxfun(@plus,log2(pX),log2(1-pY))+log2(pXY0);
ic = ic ./ -log2(pXY0);
